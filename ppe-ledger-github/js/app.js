...
function renderDepreciation() {
  ...
  el.innerHTML = `
    <div class="panel">
      <div class="toolbar">
        ...
        ${isPosted
          ...
          : `<button class="btn primary" onclick="postPeriod('${period}')" ${assetRows.length ? "" : "disabled"}>Post ${periodLabel(period)} depreciation</button>`}
      </div>
      <div class="panel-body">
    ...
    <div class="panel">
      <div class="panel-head"><h3>Per-asset detail</h3></div>
      <div class="panel-body flush"><div class="tablewrap"><table>
...
function renderRetired() {
  ...
  el.innerHTML = `
    <div class="panel">
      <div class="panel-head"><div><h3>Retired / derecognized assets</h3><div class="desc">${rows.length} item(s) — kept for history, excluded from active depreciation and reconciliation totals</div></div></div>
      <div class="panel-body flush"><div class="tablewrap"><table>
